...
import Logo from "../../assets/icons/diuLogo.png";
import LoginSvg from "../../assets/images/greenDiu.jpg";
    ...
    <>
      ...
      <div className="flex justify-center items-center w-full h-screen">
        <img
          src={LoginSvg}
          alt="Svg Image"
          className="absolute bottom-6 left-1 w-full h-screen blur-sm contrast-125"
          style={{ zIndex: "-22222" }}
        />
        <div className="w-9/12 sm:w-5/12 md:w-5/12 lg:w-3/12 xl:6/12 z-9 backdrop-saturate-200 drop-shadow-lg blur-none bg-inherit">
          <img src={Logo} alt="Logo" className="m-auto w-34 h-30 contrast-125 brightness-125" />
          {roleType ? (
            ...
            <div>
              ...
              <Link
                ...
                onClick={() => {
                  setRoleType(true), setRole("Student");
                }}
              >
                Choose your role?
              </Link>
