        ...
        <div className="w-9/12 sm:w-5/12 md:w-5/12 lg:w-3/12 xl:6/12 z-9">
          ...
          <div className="my-5">
            <div className="relative">
              ...
              <input
                type="text"
                className="h-9 w-full border border-blue-900 rounded-md my-2 pl-11 py-4 "
                placeholder="EMAIL"
                onChange={(e) => {
          ...
          <button
            ...
            className="cursor-pointer w-full bg-blue-100 hover:bg-blue-600  py-2.5 rounded-md font-poppins font-semibold text-white shadow-btn"
          >
